...
$GLOBALS["netmrg"]["imagespec"] = array(
    "applytemplate"              => "applytemplate.png",
    "edit"                       => "edit.png",
    ...
    "arrow_limit-up"             => "arrow_limit-up.png",
    "arrow_limit-right"          => "arrow_limit-right.png",
    "arrow_limit-down"           => "arrow_limit-down.png",
    "arrow_limit-left"           => "arrow_limit-left.png",
    "arrow_limit-up-disabled"    => "arrow_limit-up-disabled.png",
    "arrow_limit-right-disabled" => "arrow_limit-right-disabled.png",
    "arrow_limit-down-disabled"  => "arrow_limit-down-disabled.png",
    "arrow_limit-left-disabled"  => "arrow_limit-left-disabled.png",
