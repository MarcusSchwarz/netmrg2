...
if ((empty($action)) || ($action == "doedit") || ($action == "dodelete") || ($action == "doadd") || ($action == "multidodelete")) {
    ...
    $test_total = getDatabase()->query('SELECT COUNT(*) FROM tests_snmp')->fetchColumn();
...
if (($action == "edit") || ($action == "add")) {
    ...
    $test_row = getDatabase()->query('SELECT * FROM tests_snmp WHERE id = '.intval($_REQUEST['test_id']))->fetch(PDO::FETCH_ASSOC);
