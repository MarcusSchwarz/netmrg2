...
//		array("name" => "Device", "link" => "device_centered.php", "descr" => "", "authLevelRequired" => 0),
    ...
    "Admin"     => array(
        ...
        array("name" => "Script", "link" => "index/settings/scripts", "descr" => "External Programs", "authLevelRequired" => 2),
        array("name" => "SNMP", "link" => "index/settings/snmp", "descr" => "SNMP Queries", "authLevelRequired" => 2),
...
if (!empty($slideshow)
    && count($slideshow["views"]) != $slideshow["current"]
    && $slideshow["current"] != 0
    && $rss_action != "slideshow"
) {
    $rss_jump = $slideshow["current"] - 1;
...
function get_image_by_name($img_name) {
    ...
    switch ($img_name) {
        ...
        case "hide"  :
            $image = "{$GLOBALS['netmrg']['staticimagedir']}/hide.gif";
            break;
        case "show"  :
...
function get_color_by_name($color_name) {
    ...
    switch ($color_name) {
        ...
        case "edit_header_text"      :
            $color = "#C0C0C0";
            break;
        case "edit_main_header"      :
            $color = "#005000";
            break;
        case "edit_main_header_text" :
            $color = "#C0C0C0";
            break;
